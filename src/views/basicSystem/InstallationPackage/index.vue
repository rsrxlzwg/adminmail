...
import mixins from '../mixins/updatabar'
export default {
  components: {
    upload
  },
  ...
  methods: {
    onAdd() {
      ...
      this.contener.innerHTML = '<input type="file" style="display:none"></input>'
      this.contener.firstChild.click()
      this.contener.addEventListener('change', (e) => {
