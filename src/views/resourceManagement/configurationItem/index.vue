<template>
  <div class="notice-container">
    <el-form :inline="true" :model="formInline" class="form-inline">
      <el-form-item>
        <el-button type="primary" @click="onAdd">添加映射</el-button>
        <el-button type="primary" @click="handleDel">删除映射</el-button>
      </el-form-item>
      <div>
        ...
        <el-form-item label>
          <el-input placeholder="配置名称" v-model="formInline.input2">
    ...
    <div class="table-templet">
      ...
      <div class="table-border">
        ...
        >
          ...
          <el-table-column align="center" label="键" prop="key">
            <template slot-scope="scope">
              <span>{{ scope.row.key }}</span>
            </template>
          </el-table-column>
          <el-table-column align="center" label="创建时间" prop="time" width="180">
       ...
       <el-dialog class="deepdialog" :title="title" :visible.sync="dialogFormVisible">
        <el-form :model="form">
          ...
          <el-form-item label="键" :label-width="formLabelWidth">
            <el-input type="textarea" v-model="form.key" autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDel(){
      console.log(this.$refs.mappingTable.selection)
      let ids=this.$refs.mappingTable.selection.map(item => {return item.id})
      console.log({ids})
